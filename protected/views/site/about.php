	<div class="heads">
		<div class="container">
			<div class="row-fluid">
				<div class="span12">
					<h2><span>//</span> Acerca de nosotros</h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row-fluid padd20-top-btm">
				<div class="span12">
					...
					<p>Con el fin de sistematizar la fabricación y las ventas , las prácticas QuadColor sistema gestión moderna , introduce método DFMEA para completar el control de calidad del producto y comprobar, QuadColor sigue las directrices PDCA ( Plan, Do , Check , acción ), así como utiliza el sistema perfecto del ERP para garantizar una excelente calidad de los productos.</p>
			...
			<div class="row-fluid padd20-top-btm">
				<div class="span8">
					...
					<p>Establecer mecanismos de distribución para llegar a todos los mercados para garantizar nuestra presencia a nivel global.</p>
